...
makedepends=('linux-bede>=4.4rc1' 'linux-bede<4.5' 'linux-bede-headers>=4.4rc1' 'linux-bede-headers<4.5' "nvidia-340xx-utils=$pkgver" "nvidia-340xx-libgl=$pkgver")
...
package() {
    depends=('linux-bede>=4.4rc1' 'linux-bede<4.5' "nvidia-340xx-utils=$pkgver" "nvidia-340xx-libgl=$pkgver")
