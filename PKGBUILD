...
makedepends=('linux-bede>=4.5rc1' 'linux-bede<4.6' 'linux-bede-headers>=4.5rc1' 'linux-bede-headers<4.6' "nvidia-340xx-utils=$pkgver" "nvidia-340xx-libgl=$pkgver")
...
package() {
    depends=('linux-bede>=4.5rc1' 'linux-bede<4.6' "nvidia-340xx-utils=$pkgver" "nvidia-340xx-libgl=$pkgver")
